...
class BeatGAN_RNN(AD_Model):
    def __init__(self,param,dataloader,device,lamda_value=0,exp_name="default"):
        super(BeatGAN_RNN, self).__init__()
        ...
        self.out_dir=os.path.join("output", exp_name)
